...
const testConfigPath = path.join(__dirname, 'temp_sb_vless_check.json');
...
fs.writeFileSync(testConfigPath, JSON.stringify(singboxVlessConfig, null, 2), 'utf8');
...
proc.on('close', code => {
  console.log(`sing-box check for VLESS Reality finished with code ${code}`);
